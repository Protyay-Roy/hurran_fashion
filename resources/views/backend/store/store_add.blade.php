        ...
        <form action="{{ route('StorePost') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row mg-t-20">
            ...
            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
              <input type="text" name="title" class="form-control" placeholder="Enter Store Title">
            </div>
          </div><!-- row -->
          ...
          <div class="row mg-t-20">
            ...
            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
              <input type="text" name="address" class="form-control" placeholder="Enter Your Store Address">
            </div>
          </div>
          ...
          <div class="row mg-t-20">
            ...
            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
              <input type="text" name="business_hours" class="form-control" placeholder="Enter Business Hours">
            </div>
          </div>
          ...
          <div class="row mg-t-20">
            ...
            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
              <input type="file" name="thumbnail" class="form-control" placeholder="Enter Store Thumbnail">
            </div>
          </div>
           ...
           <div class="row mg-t-20">
            ...
            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
              <input type="text" name="link" class="form-control" placeholder="Enter Google Maps Link">
            </div>
          </div>
