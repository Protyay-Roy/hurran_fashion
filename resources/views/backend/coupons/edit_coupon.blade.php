          ...
          <form action="{{ route('CouponUpdate') }}" method="POST">
            ...
            <div class="row" style="margin-bottom: 15px;">
              ...
              <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                <input type="text" name="name" class="form-control" value="{{ $coupon_edit->name }}" placeholder="Enter Coupon Name" required>
              </div>
            </div><!-- row -->
            ...
            <div class="row" style="margin-bottom: 15px;">
              ...
              <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                <input type="text" name="code" class="form-control" value="{{ $coupon_edit->code }}" placeholder="Enter Coupon Code" required>
              </div>
            </div><!-- row -->
            ...
            <div class="row" style="margin-bottom: 15px;">
              ...
              <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                <input type="datetime-local" name="validity" value="{{ $coupon_edit->validity }}" class="form-control" placeholder="Enter Coupon Validity Date" required>
              </div>
            </div><!-- row -->
            ...
            <div class="row" style="margin-bottom: 15px;">
              ...
              <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                <input type="text" name="discount" class="form-control" value="{{ $coupon_edit->discount }}" placeholder="Enter Coupon Discount" required>
              </div>
            </div><!-- row -->
            ...
            <div class="row" style="margin-bottom: 15px;">
              ...
              <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                <input type="text" name="level" value="{{ $coupon_edit->level }}" class="form-control" placeholder="Enter Discount Level" required>
              </div>
            </div><!-- row -->
