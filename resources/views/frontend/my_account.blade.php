                        ...
                        <div class="col-md-8 col-lg-9">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab-dashboard" role="tabpanel"
                                    ...
                                    <img src="{{ url('Pro_images/1/' . auth()->user()->images) }}" alt=""
                                        style="height: 300px; width:300px; border-radius:10px">
                                    {{-- <h5 class="mt-3">Name : {{auth()->user()->name}}</h5> <span>hii</span> --}}
                                    <a href="" class="btn btn-success mt-3">Change Image</a>
                                </div><!-- .End .tab-pane -->
                                        ...
                                        @foreach ($orders as $order)
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ $order['product_unit_price'] * $order['quantity'] }}</td>
                                                    <td>running</td>
                                                </tr>
                                            </tbody>
                                        @endforeach
