...
use App\Notifications\OrderNotification as NotificationsOrderNotification;
//Paypal
...
class PaymentController extends Controller
{
    ...
    // {
    //     echo "ok";
    //     OrderNotification::dispatch("Order request successful. Please accept Order");
    // }
    ...
    function payment(Request $request)
    {
        ...
        //     $order = $order;
        // }
        // auth()->user()->notify(new NotificationsOrderNotification($order));
        ...
        if ($request->payment == 'card') {
            ...
            $shipping->state_name = $request->state_name;
            ...
            // $shipping_auth_ids = Shipping::get();
            // foreach($shipping_auth_ids as $shipping_auth_id ){
            //     if()
            // }
